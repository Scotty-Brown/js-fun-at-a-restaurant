...
if (isFavorite === true){
    console.log(`My favorite food are ${food}!`)
} else {
...
var vegetables = ['carrot', 'potato', 'onion', 'pepper', 'squash']
...
// different fruits.
var fruits = ['apple', 'peach', 'mango', 'orange', 'kiwi', 'mango', 'pear']
...
// I would add a few more key value pairs like - address - phone number - is there a sale going on? - accepts apple pay?
